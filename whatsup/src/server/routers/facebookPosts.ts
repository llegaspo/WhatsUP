  ...
  create: publicProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      try {
        ...
        if (newFBPost) return { message: "FacebookPost create Successfully" };
        else return { message: "FacebookPost cannot be created" };
      } catch {
  ...
  delete: publicProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        ...
        throw new Error(
          "An error has occured while deleting the facebook post",
        );
      }
    }),
  ...
  update: publicProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        ...
        throw new Error(
          "An error has occured while updating the facebook post.",
        );
      }
    }),
});
